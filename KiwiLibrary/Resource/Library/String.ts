...
function maxLengthOfStrings(strs: string[]): number {
        let result: number = 0 ;
        for(let str of strs){
...
function adjustLengthOfStrings(strs: string[]): string[] {
...
function pasteStrings(src0: string[], src1: string[], space: string): string[]
{
